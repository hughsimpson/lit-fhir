...
object Coding extends CompanionFor[Coding] {
  ...
  def extractVersion(t: Coding): Option[FHIRString]   = t.version
  def extractDisplay(t: Coding): Option[FHIRString]   = t.display
  ...
  def unapply(
      o: Coding): Option[(Option[String], Option[Code], Option[UriStr], Option[FHIRString], Option[FHIRString], LitSeq[Extension], Option[Boolean])] =
