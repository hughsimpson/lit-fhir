...
object Count extends CompanionFor[Count] {
  ...
  def extractUnit(t: Count): Option[FHIRString]                = t.unit
  ...
  def unapply(
      o: Count): Option[(Option[String], Option[FHIRString], Option[Code], Option[BigDecimal], Option[UriStr], LitSeq[Extension], Option[QUANTITY_COMPARATOR])] =
