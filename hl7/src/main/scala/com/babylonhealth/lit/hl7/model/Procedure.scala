...
object Procedure extends CompanionFor[Procedure] {
  ...
  class Performer(
      ...
      override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts)
      extends BackboneElement(id = id, extension = extension, modifierExtension = modifierExtension)
  type PerformedChoice = Choice[Union_0461247536]
  def apply(
      id: Option[String] = None,
  ...
  val performed: FHIRComponentFieldMeta[Option[Procedure.PerformedChoice]] =
    FHIRComponentFieldMeta("performed", lTagOf[Option[Procedure.PerformedChoice]], true, lTagOf[Union_0461247536])
    ...
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Procedure(
          ...
          cursor.decodeOptRef[Union_0461247536]("performed"),
