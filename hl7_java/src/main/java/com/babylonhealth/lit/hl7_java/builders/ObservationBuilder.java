...
public interface ObservationBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ObservationBuilder {
     ...
     *     CodeableConcept, FHIRDateTime, String, Integer, LocalTime, Period, Quantity, Range,
     *     Ratio, SampledData. To pass the value in, wrap with one of the ObservationBuilder.value
     *     static methods
     */
    public ObservationBuilder.Impl withValue(@NonNull Choice02087996915 value) {
