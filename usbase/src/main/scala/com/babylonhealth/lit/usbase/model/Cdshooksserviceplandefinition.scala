...
object Cdshooksserviceplandefinition extends CompanionFor[Cdshooksserviceplandefinition] {
  ...
  def extractName(t: Cdshooksserviceplandefinition): Option[FHIRString]             = t.name
  ...
  def extractTitle(t: Cdshooksserviceplandefinition): Option[FHIRString]            = t.title
  def extractUsage(t: Cdshooksserviceplandefinition): Option[FHIRString]            = t.usage
  ...
  def extractVersion(t: Cdshooksserviceplandefinition): Option[FHIRString]          = t.version
  ...
  def extractSubtitle(t: Cdshooksserviceplandefinition): Option[FHIRString]         = t.subtitle
  ...
  def extractPublisher(t: Cdshooksserviceplandefinition): Option[FHIRString]        = t.publisher
