...
object Codesystem_label extends CompanionFor[Codesystem_label] {
  ...
  def extractValue(t: Codesystem_label): FHIRString                      = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Codesystem_label): Option[(Option[String], FHIRString)] = Some((o.id, o.value.get.toSubRefNonUnion[FHIRString]))
