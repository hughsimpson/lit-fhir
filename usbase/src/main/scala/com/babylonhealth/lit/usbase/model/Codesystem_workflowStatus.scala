...
object Codesystem_workflowStatus extends CompanionFor[Codesystem_workflowStatus] {
  ...
  def extractValue(t: Codesystem_workflowStatus): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Codesystem_workflowStatus): Option[(Option[String], FHIRString)] = Some(
