...
object Contactpoint_local extends CompanionFor[Contactpoint_local] {
  ...
  def extractValue(t: Contactpoint_local): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Contactpoint_local): Option[(Option[String], FHIRString)] = Some(
