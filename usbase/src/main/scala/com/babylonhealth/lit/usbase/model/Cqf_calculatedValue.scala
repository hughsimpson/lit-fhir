...
object Cqf_calculatedValue extends CompanionFor[Cqf_calculatedValue] {
  ...
  def extractValue(t: Cqf_calculatedValue): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Cqf_calculatedValue): Option[(Option[String], FHIRString)] = Some(
