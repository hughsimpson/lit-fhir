...
object Cqllibrary extends CompanionFor[Cqllibrary] {
  ...
  def extractName(t: Cqllibrary): Option[FHIRString]                  = t.name
  def extractType(t: Cqllibrary): CodeableConcept                     = t.`type`
  def extractDate(t: Cqllibrary): Option[FHIRDateTime]                = t.date
  def extractTitle(t: Cqllibrary): Option[FHIRString]                 = t.title
  def extractUsage(t: Cqllibrary): Option[FHIRString]                 = t.usage
  ...
  def extractVersion(t: Cqllibrary): Option[FHIRString]               = t.version
  ...
  def extractSubtitle(t: Cqllibrary): Option[FHIRString]              = t.subtitle
  ...
  def extractPublisher(t: Cqllibrary): Option[FHIRString]             = t.publisher
