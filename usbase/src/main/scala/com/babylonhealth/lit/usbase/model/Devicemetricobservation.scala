...
object Devicemetricobservation extends CompanionFor[Devicemetricobservation] {
  ...
  type ValueChoice = Choice[Union02005089322]
  def apply(
  ...
  val value: FHIRComponentFieldMeta[Option[Devicemetricobservation.ValueChoice]] =
    FHIRComponentFieldMeta("value", lTagOf[Option[Devicemetricobservation.ValueChoice]], true, lTagOf[Union02005089322])
    ...
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Devicemetricobservation(
          ...
          cursor.decodeOptRef[Union02005089322]("value"),
