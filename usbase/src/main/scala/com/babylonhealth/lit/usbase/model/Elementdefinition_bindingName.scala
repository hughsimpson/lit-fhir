...
object Elementdefinition_bindingName extends CompanionFor[Elementdefinition_bindingName] {
  ...
  def extractValue(t: Elementdefinition_bindingName): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Elementdefinition_bindingName): Option[(Option[String], FHIRString)] = Some(
