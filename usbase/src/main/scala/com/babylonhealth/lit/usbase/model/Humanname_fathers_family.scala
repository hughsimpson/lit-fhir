...
object Humanname_fathers_family extends CompanionFor[Humanname_fathers_family] {
  ...
  def extractValue(t: Humanname_fathers_family): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Humanname_fathers_family): Option[(Option[String], FHIRString)] = Some(
