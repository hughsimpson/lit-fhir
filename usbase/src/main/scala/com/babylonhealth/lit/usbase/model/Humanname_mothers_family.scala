...
object Humanname_mothers_family extends CompanionFor[Humanname_mothers_family] {
  ...
  def extractValue(t: Humanname_mothers_family): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Humanname_mothers_family): Option[(Option[String], FHIRString)] = Some(
