...
object Humanname_own_name extends CompanionFor[Humanname_own_name] {
  ...
  def extractValue(t: Humanname_own_name): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Humanname_own_name): Option[(Option[String], FHIRString)] = Some(
