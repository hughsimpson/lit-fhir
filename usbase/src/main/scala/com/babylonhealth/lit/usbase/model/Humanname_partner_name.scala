...
object Humanname_partner_name extends CompanionFor[Humanname_partner_name] {
  ...
  def extractValue(t: Humanname_partner_name): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Humanname_partner_name): Option[(Option[String], FHIRString)] = Some(
