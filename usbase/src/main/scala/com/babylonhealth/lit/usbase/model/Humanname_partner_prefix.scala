...
object Humanname_partner_prefix extends CompanionFor[Humanname_partner_prefix] {
  ...
  def extractValue(t: Humanname_partner_prefix): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Humanname_partner_prefix): Option[(Option[String], FHIRString)] = Some(
