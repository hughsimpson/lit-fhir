...
object Iso21090_ADXP_additionalLocator extends CompanionFor[Iso21090_ADXP_additionalLocator] {
  ...
  def extractValue(t: Iso21090_ADXP_additionalLocator): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_additionalLocator): Option[(Option[String], FHIRString)] = Some(
