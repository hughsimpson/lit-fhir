...
object Iso21090_ADXP_careOf extends CompanionFor[Iso21090_ADXP_careOf] {
  ...
  def extractValue(t: Iso21090_ADXP_careOf): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_careOf): Option[(Option[String], FHIRString)] = Some(
