...
object Iso21090_ADXP_deliveryInstallationQualifier extends CompanionFor[Iso21090_ADXP_deliveryInstallationQualifier] {
  ...
  def extractValue(t: Iso21090_ADXP_deliveryInstallationQualifier): FHIRString = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_deliveryInstallationQualifier): Option[(Option[String], FHIRString)] = Some(
