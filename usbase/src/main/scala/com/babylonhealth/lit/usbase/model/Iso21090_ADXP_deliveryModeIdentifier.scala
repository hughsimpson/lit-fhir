...
object Iso21090_ADXP_deliveryModeIdentifier extends CompanionFor[Iso21090_ADXP_deliveryModeIdentifier] {
  ...
  def extractValue(t: Iso21090_ADXP_deliveryModeIdentifier): FHIRString = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_deliveryModeIdentifier): Option[(Option[String], FHIRString)] = Some(
