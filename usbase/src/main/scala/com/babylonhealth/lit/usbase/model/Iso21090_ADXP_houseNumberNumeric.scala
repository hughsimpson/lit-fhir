...
object Iso21090_ADXP_houseNumberNumeric extends CompanionFor[Iso21090_ADXP_houseNumberNumeric] {
  ...
  def extractValue(t: Iso21090_ADXP_houseNumberNumeric): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_houseNumberNumeric): Option[(Option[String], FHIRString)] = Some(
