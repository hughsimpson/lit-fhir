...
object Iso21090_ADXP_streetAddressLine extends CompanionFor[Iso21090_ADXP_streetAddressLine] {
  ...
  def extractValue(t: Iso21090_ADXP_streetAddressLine): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_streetAddressLine): Option[(Option[String], FHIRString)] = Some(
