...
object Iso21090_ADXP_streetName extends CompanionFor[Iso21090_ADXP_streetName] {
  ...
  def extractValue(t: Iso21090_ADXP_streetName): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_streetName): Option[(Option[String], FHIRString)] = Some(
