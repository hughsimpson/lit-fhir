...
object Iso21090_ADXP_streetNameBase extends CompanionFor[Iso21090_ADXP_streetNameBase] {
  ...
  def extractValue(t: Iso21090_ADXP_streetNameBase): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Iso21090_ADXP_streetNameBase): Option[(Option[String], FHIRString)] = Some(
