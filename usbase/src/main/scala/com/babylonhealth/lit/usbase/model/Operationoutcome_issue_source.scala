...
object Operationoutcome_issue_source extends CompanionFor[Operationoutcome_issue_source] {
  ...
  def extractValue(t: Operationoutcome_issue_source): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Operationoutcome_issue_source): Option[(Option[String], FHIRString)] = Some(
