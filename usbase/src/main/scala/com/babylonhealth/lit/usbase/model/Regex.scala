...
object Regex extends CompanionFor[Regex] {
  ...
  def extractValue(t: Regex): FHIRString                      = t.value.get.toSubRefNonUnion[FHIRString]
  override val thisName: String                               = "Regex"
  override val searchParams: Map[String, Regex => Seq[Any]]   = Extension.searchParams
  def unapply(o: Regex): Option[(Option[String], FHIRString)] = Some((o.id, o.value.get.toSubRefNonUnion[FHIRString]))
