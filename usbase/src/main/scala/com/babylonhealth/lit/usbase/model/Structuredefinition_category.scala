...
object Structuredefinition_category extends CompanionFor[Structuredefinition_category] {
  ...
  def extractValue(t: Structuredefinition_category): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Structuredefinition_category): Option[(Option[String], FHIRString)] = Some(
