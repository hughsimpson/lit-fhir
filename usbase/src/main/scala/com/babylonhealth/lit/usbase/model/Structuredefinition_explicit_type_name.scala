...
object Structuredefinition_explicit_type_name extends CompanionFor[Structuredefinition_explicit_type_name] {
  ...
  def extractValue(t: Structuredefinition_explicit_type_name): FHIRString = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Structuredefinition_explicit_type_name): Option[(Option[String], FHIRString)] = Some(
