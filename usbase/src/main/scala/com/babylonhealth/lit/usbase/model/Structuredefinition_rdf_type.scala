...
object Structuredefinition_rdf_type extends CompanionFor[Structuredefinition_rdf_type] {
  ...
  def extractId(t: Structuredefinition_rdf_type): Option[FHIRString]               = t.id
  def extractValue(t: Structuredefinition_rdf_type): Option[FHIRString]            = t.value.map(_.toSubRefNonUnion[FHIRString])
  ...
  def unapply(o: Structuredefinition_rdf_type): Option[(Option[FHIRString], Option[FHIRString])] = Some(
