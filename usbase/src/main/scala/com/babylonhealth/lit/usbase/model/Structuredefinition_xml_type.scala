...
object Structuredefinition_xml_type extends CompanionFor[Structuredefinition_xml_type] {
  ...
  def extractId(t: Structuredefinition_xml_type): Option[FHIRString]               = t.id
  def extractValue(t: Structuredefinition_xml_type): Option[FHIRString]            = t.value.map(_.toSubRefNonUnion[FHIRString])
  ...
  def unapply(o: Structuredefinition_xml_type): Option[(Option[FHIRString], Option[FHIRString])] = Some(
