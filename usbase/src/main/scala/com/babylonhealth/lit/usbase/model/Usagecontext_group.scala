...
object Usagecontext_group extends CompanionFor[Usagecontext_group] {
  ...
  def extractValue(t: Usagecontext_group): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Usagecontext_group): Option[(Option[String], FHIRString)] = Some(
