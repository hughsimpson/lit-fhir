...
object Valueset_concept_comments extends CompanionFor[Valueset_concept_comments] {
  ...
  def extractValue(t: Valueset_concept_comments): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Valueset_concept_comments): Option[(Option[String], FHIRString)] = Some(
