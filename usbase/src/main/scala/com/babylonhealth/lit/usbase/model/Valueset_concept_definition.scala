...
object Valueset_concept_definition extends CompanionFor[Valueset_concept_definition] {
  ...
  def extractValue(t: Valueset_concept_definition): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Valueset_concept_definition): Option[(Option[String], FHIRString)] = Some(
