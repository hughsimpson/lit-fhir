...
object Valueset_keyWord extends CompanionFor[Valueset_keyWord] {
  ...
  def extractValue(t: Valueset_keyWord): FHIRString                      = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Valueset_keyWord): Option[(Option[String], FHIRString)] = Some((o.id, o.value.get.toSubRefNonUnion[FHIRString]))
