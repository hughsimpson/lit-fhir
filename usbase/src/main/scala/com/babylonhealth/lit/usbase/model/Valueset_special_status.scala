...
object Valueset_special_status extends CompanionFor[Valueset_special_status] {
  ...
  def extractValue(t: Valueset_special_status): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Valueset_special_status): Option[(Option[String], FHIRString)] = Some(
