...
object Valueset_workflowStatus extends CompanionFor[Valueset_workflowStatus] {
  ...
  def extractValue(t: Valueset_workflowStatus): FHIRString                    = t.value.get.toSubRefNonUnion[FHIRString]
  ...
  def unapply(o: Valueset_workflowStatus): Option[(Option[String], FHIRString)] = Some(
